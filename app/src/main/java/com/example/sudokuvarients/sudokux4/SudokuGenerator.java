...
public class SudokuGenerator {
    private static com.example.sudokuvarients.sudokux4.SudokuGenerator instance;
    ...
    public static com.example.sudokuvarients.sudokux4.SudokuGenerator getInstance(){
        if( instance == null ){
            instance = new com.example.sudokuvarients.sudokux4.SudokuGenerator();
        }
        return instance;
    }
    ...
    public int[][] removeElements( int[][] Sudoku ){
        int i = 0;
        int cleanse = new Random().nextInt(7) + 5;
